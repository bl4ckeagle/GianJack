...
class Newsletter extends \AppBundle\Entity\Newsletter implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Newsletter' . "\0" . 'newsletterId', '' . "\0" . 'AppBundle\\Entity\\Newsletter' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Newsletter' . "\0" . 'activated'];
        }
    ...
    public function getNewsletterId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getNewsletterId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNewsletterId', []);

        return parent::getNewsletterId();
    }
